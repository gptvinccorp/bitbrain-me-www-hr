...
export const questions: Question[] = [
  {
    ...
    textKey: 'q1.text',
    options: [
      { key: 'a', textKey: 'q1.a', score: 10 },
      { key: 'b', textKey: 'q1.b', score: 0 },
      { key: 'c', textKey: 'q1.c', score: 0 },
  ...
  },
  {
    ...
    textKey: 'q2.text',
    options: [
      { key: 'a', textKey: 'q2.a', score: 0 },
      { key: 'b', textKey: 'q2.b', score: 10 },
      { key: 'c', textKey: 'q2.c', score: 0 },
  ...
  },
  {
    ...
    textKey: 'q3.text',
    options: [
      { key: 'a', textKey: 'q3.a', score: 0 },
      { key: 'b', textKey: 'q3.b', score: 0 },
      { key: 'c', textKey: 'q3.c', score: 10 },
      { key: 'd', textKey: 'q3.d', score: 0 }
    ],
    correctAnswer: 'c',
    maxScore: 10,
  ...
  },
  {
    ...
    textKey: 'q4.text',
    options: [
      { key: 'a', textKey: 'q4.a', score: 0 },
      { key: 'b', textKey: 'q4.b', score: 10 },
      { key: 'c', textKey: 'q4.c', score: 0 },
  ...
  },
  {
    ...
    options: [
      ...
      { key: 'b', textKey: 'q5.b', score: 0 },
      { key: 'c', textKey: 'q5.c', score: 0 },
  ...
  },
  {
    ...
    options: [
      ...
      { key: 'c', textKey: 'q11.c', score: 8 },
      { key: 'd', textKey: 'q11.d', score: 10 }
    ],
    correctAnswer: 'd',
    maxScore: 10
  }
